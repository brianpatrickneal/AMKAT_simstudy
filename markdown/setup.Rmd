---
title: "Setup Details for Simulation Scenarios"
author: "Brian Neal"
date: "3/29/2022"
output: 
  html_document:
...
Here we provide a detailed exposition of the process involved in preparing the working environment to simulate data for an individual scenario.  
...
Sample correlation heatmaps for the sparse and dense signal sets using simulated SNP-set data can be viewed at **(insert link)**.
